...
$rel = new Relatorios();
$rel->setDataInicio(RegNegocios::arrumaData($_SESSION['dataInicio'], 'arrumar'));
$rel->setDataFim(RegNegocios::arrumaData($_SESSION['dataFim'], 'arrumar'));
...
$pdf->Cell(0, 10, "Data inicio: ".RegNegocios::arrumaData($rel->getDataInicio(), 'mostrar') . "    Data final: ".RegNegocios::arrumaData($rel->getDataFim(), 'mostrar'), 0, 0, "C" );
$pdf->ln();
