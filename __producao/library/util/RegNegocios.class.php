...
// fecha  function conecta
    ...
    function executeQuery($CmdQuery, $gravarLog = true) { // codigo de erro SI0803
        ...
        if (strtoupper($temp[0]) == "INSERT") {
            $this->lastIdInsert = mysql_insert_id($this->IdtLink);
        } else if (strtoupper($temp[0] == "SELECT")) {
...
// APRIMORAR MELHOR ESTE MÉTODO.. EMERGENCIAL
    ...
    public static function gravaLog($nomeArquivo, $texto) {
        /*
          ...
          return true;
         */
        $arquivo = PATH . "/analizze/logs/" . $nomeArquivo . ".txt";
//		die($arquivo);
